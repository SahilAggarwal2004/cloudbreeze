...
export default function MyApp({ Component, pageProps }) {
    ...
    return <>
        <Head>
            ...
            <meta name="description" content="CloudBreeze is an online platform to where you can share files via cloud or p2p between your friends. We respect your privacy and that's why we make sure your files are totally encrypted and password protected." />
