...
export default function PeerCard({ data: { name, conn }, names, sizes, totalSize }) {
  ...
  return (
    <div className="relative flex min-w-67.5 flex-col justify-center rounded-sm border bg-gray-50 p-4 pb-0 text-center transition-all duration-300 hover:bg-transparent hover:shadow-lg">
